(function () {
  function removeTeachers() {
    const errorMessage =
      'Could not remove the ugly teachers, something must have changed. Please report this error to the developer.';
    const targets = {
      selectors: ['.clouds', '#kids'],
      imageSources: [
        'forside.svg',
      ...
      elementsWithBackgroundImages: ['.my-week-background-wrapper'],
    };
